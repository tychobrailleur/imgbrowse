(ns imgbrowse.core
  ...
  (:import [java.io File]
           [java.awt RenderingHints Toolkit]
...
(defn update-image [_image] (.getAbsolutePath (rand-nth @the-images)))
            ...
            (fn [e]
              (let [key-pressed (.getKeyCode e)]
                (cond
                  ...
                  (do (swap! the-image update-image)
                      (.setTitle f (str "ImgBrowse – " @the-image))))
                (repaint! c)))))
  f)
